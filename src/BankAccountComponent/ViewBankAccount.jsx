...
const ViewBankAccount = () => {
  ...
  const retrieveBankAccount = async () => {
    const response = await axios.get(
      "https://bankapi.pod2-c4.online.online/api/bank/account/fetch/user?userId=" + customer.id,
      {
        headers: {
  ...
  const downloadStatement = (e) => {
    ...
    fetch(
      "https://bankapi.pod2-c4.online.online/api/bank/transaction/statement/download?accountId=" +
        bankAccount.id +
        "&startTime=" +
  ...
  const depositAmount = (e) => {
    ...
    fetch("https://bankapi.pod2-c4.online.online/api/bank/transaction/deposit", {
      method: "POST",
      headers: {
  ...
  const withdrawAmount = (e) => {
    ...
    fetch("https://bankapi.pod2-c4.online.online/api/bank/transaction/withdraw", {
      method: "POST",
      headers: {
        Accept: "application/json",
        "Content-Type": "application/json",
