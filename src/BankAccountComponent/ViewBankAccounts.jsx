...
const ViewBankAccounts = () => {
  ...
  const retrieveAllAccounts = async () => {
    const response = await axios.get(
      "https://bankapi.pod2-c4.online.online/api/bank/account/fetch/bankwise?bankId=" +
        bank.bank.id,
      {
        headers: {
  ...
  const retrieveAllAccountsByBankAccount = async () => {
    const response = await axios.get(
      "https://bankapi.pod2-c4.online.online/api/bank/account/search?bankId=" +
        bank.bank.id +
        "&accountNumber=" +
        accountNumber,
      {
  ...
  const openAccount = (accountId, e) => {
    ...
    fetch("https://bankapi.pod2-c4.online.online/api/bank/account/update/status", {
      method: "POST",
      headers: {
