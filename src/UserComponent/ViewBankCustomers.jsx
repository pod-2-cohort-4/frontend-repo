...
const ViewBankCustomers = () => {
  ...
  const retrieveAllCustomers = async () => {
    const response = await axios.get(
      "https://bankapi.favour-ibe.online/api/user/bank/customers?bankId=" + bank.bank.id,
      {
        headers: {
  ...
  const retrieveBankAllCustomerByName = async () => {
    const response = await axios.get(
      "https://bankapi.favour-ibe.online/api/user/bank/customer/search?bankId=" +
        bank.bank.id +
        "&customerName=" +
        customerName,
      {
  ...
  const activateUser = (userId, e) => {
    ...
    fetch("https://bankapi.favour-ibe.online/api/user/update/status", {
      method: "POST",
      headers: {
